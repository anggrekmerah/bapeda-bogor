...
const ioSocket = io('http://'+window.location.hostname+':3010',{
...
function incomnigBox(params) {
    ...
    var incomingBox  = '<div class="col-md-2 my-1" id="incomingCall_'+ext+'" card-incoming="card-'+params.caller.caller.number+'">'
        ...
        incomingBox += '                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">'
        incomingBox += '                        <li>'
        ...
        incomingBox += '            <div class="table-responsive">'
